...
# CRITICAL FIX: Added 'api.' directly before the telegram domain core
...
def reach_telegram(chat_id, text_content):
    ...
    try:
        ...
        logging.info(f"📡 Status Code: {response.status_code} | Body: {response.text[:200]}")
