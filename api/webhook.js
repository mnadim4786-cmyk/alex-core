...
Apne malik ke saath Hinglish mein baat kar.
Unke projects: XAUUSD Trading, Import/Export, Clean Energy R&D.
Hamesha helpful aur loyal reh.`,
          },
          ...messages,
        ],
        max_tokens: 1000,
    ...
    console.log("DeepSeek:", JSON.stringify(data));
    ...
    return "AI se connect nahi ho paya.";
  }
}
